...
#Bob Pos
pulseCenterWfm_Ch2 = 0.1557#0.15#0.083
#Bob Marker
pulseCenterMkr1_Ch2 = 0.15


delayStep = 3240*10**(-12) #s
scanRange = 3240 * 10**(-12)
...
try:
    ...
    wfm_arr_ch1=AWGFunc.createWaveformOnePulseArray(repRate, wfmPulseWidth,pulseCenter=pulseCenterWfm_Ch1) #Creates double pulse for channel 1
    ...
    wfm_arr_ch2=AWGFunc.createWaveformOnePulseArray(repRate, wfmPulseWidth,pulseCenter=pulseCenterWfm_Ch2) #Creates double pulse for channel 1
