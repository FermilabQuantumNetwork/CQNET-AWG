...
print(clockCycle)
pulseN     = 1 #number of pulses
pulseWidth = 2*40e-12 #in seconds
pulseSep   = 10e-9 #in seconds
separation = 2.1e-9/clockCycle
pulseStart = 0.018 #fraction of sample in which pulse will start Starting point of pulses
pulseStart_2 = 0.018-separation #fraction of sample in which pulse will start Starting point of pulses
diff = 0.0116
