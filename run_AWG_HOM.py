...
repRate = 10*10**6 #Clock rate (Hz)
wfmPulseWidth=40e-12 #in seconds
markerPulseWidth = 40e-12

pulseCenterWfm_Ch1 = 0.15
#Alice Marker
pulseCenterMkr1_Ch1 = 0.05
#Bob Pos
#pulseCenterWfm_Ch2 = 0.1468#Min setting for Bob (max overlap with Alice)
pulseCenterWfm_Ch2 = 0.13
#Bob Marker
...
#wfm_arr_ch2=AWGFunc.createWaveformTwoPulseArray(repRate, wfmPulseWidth,pulseSep,pulseCenter=pulseCenterWfm_Ch2) #Creates double pulse for channel 1
